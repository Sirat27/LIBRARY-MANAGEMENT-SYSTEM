...
<html lang="en">
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php"><u>Library Management System </u> </a>
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav pull-right">
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="images/ava4.png" class="nav-avatar" />
                                <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="index.php">Your Profile</a></li>
                                    <li><a href="edit_student_details.php">Edit Profile</a></li>
                                    <li><a href="edit_student_details.php">Account Settings</a></li>
                                    <li class="divider"></li>
                    ...
                    <div class="span9">
                    	<center>
                           	<div class="card" style="width: 50%;"> 
                    			<img class="card-img-top" src="images/ava4.png" alt="Card image cap">
                    			<div class="card-body">
        ...
        <div class="footer">
            <b><h4 color = "white">Library Management System.</h4></b>
        </div>
