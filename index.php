...
<body>
	...
	<div class="container">
		...
		<div class="login">
			...
			<form action="index.php" method="post">
				...
				<div><font color="white"><a class="underline" href="forgots.html">Forgot password?</a></font></div>
		...
		<div class="register">
			...
			<form action="index.php" method="post">
				...
				<select name="Category" id="Category" style=color:white>
					<option value="GEN" style=color:black>General</option>
			...
			<p>By creating an account, you agree to our <a class="underline" href="term.html">Terms</a></p>
			<div class="clear"></div>
		</div>
	...
	<div class = "caption">
		<h1><u><b><i>CREATED BY SIRAT SINGH ANAND</i></b></u></h1>
